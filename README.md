...
Do the three in any order; each dot is one full round of all three. Three full rounds fill the dots. Hover any word for its English meaning, click it to hear it on its own. The **Speed** picker is a CEFR level: B2 is the voice at its natural pace, A1 is 30% slower, C2 is 20% faster.
